...
public class Ban {
    ...
    public void setMaKhuVuc(String v) {
        this.maKhuVuc = v;
    }
    ...
    public void setTrangThai(TrangThaiBan v) {
        this.trangThai = v;
    }
